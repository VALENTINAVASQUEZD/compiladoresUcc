...
def serializedATN():
    return [
        ...
        4,0,2,1,0,1,2,1,0,3,4,42,0,6,1,0,0,0,2,18,1,0,0,0,4,34,1,0,0,0,6,
        7,3,2,1,0,7,8,5,0,0,1,8,1,1,0,0,0,9,10,6,1,-1,0,10,11,5,2,0,0,11,
        19,3,2,1,4,12,13,5,6,0,0,13,14,3,2,1,0,14,15,5,7,0,0,15,19,1,0,0,
        0,16,19,3,4,2,0,17,19,5,8,0,0,18,9,1,0,0,0,18,12,1,0,0,0,18,16,1,
        0,0,0,18,17,1,0,0,0,19,31,1,0,0,0,20,21,10,7,0,0,21,22,7,0,0,0,22,
        30,3,2,1,8,23,24,10,6,0,0,24,25,7,1,0,0,25,30,3,2,1,7,26,27,10,5,
        0,0,27,28,5,5,0,0,28,30,3,2,1,6,29,20,1,0,0,0,29,23,1,0,0,0,29,26,
        1,0,0,0,30,33,1,0,0,0,31,29,1,0,0,0,31,32,1,0,0,0,32,3,1,0,0,0,33,
        31,1,0,0,0,34,35,5,9,0,0,35,36,5,6,0,0,36,37,3,2,1,0,37,38,5,7,0,
        0,38,5,1,0,0,0,3,18,29,31
    ]
...
class CalculadoraParser ( Parser ):
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = CalculadoraParser.ExpresionContext(self, _parentctx, _parentState)
    ...
    class FuncionContext(ParserRuleContext):
        ...
        def IDENT(self):
            return self.getToken(CalculadoraParser.IDENT, 0)
    ...
    def funcion(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 34
            self.match(CalculadoraParser.IDENT)
            self.state = 35
            self.match(CalculadoraParser.T__5)
            self.state = 36
            self.expresion(0)
